...
app.get('/ceo', (req, res) => {
  try {
    ...
    if (fs.existsSync(templatePath)) {
      ...
      // IExperts review data (same as /reviewer route)
      const IE_REVIEWS_CEO = {"R1-1.1.1":{"s":"approved"},"R1-1.1.2":{"s":"approved"},"R1-1.2.1":{"s":"approved"},"R1-1.2.1/2":{"s":"approved"},"R1-1.2.2":{"s":"approved"},"R1-1.2.3":{"s":"need_review"},"R1-1.2.3/2":{"s":"need_review"},"R1-1.2.4":{"s":"need_review"},"R1-1.2.5":{"s":"approved"},"R1-1.2.7":{"s":"rejected"},"R1-1.2.8":{"s":"approved"},"R1-1.2.8/2":{"s":"na"},"R1-1.3.3":{"s":"approved"},"R1-1.3.3/2":{"s":"need_review"},"R1-1.4.3":{"s":"need_review"},"R1-1.4.5":{"s":"not_reviewed"},"R1-1.5.1":{"s":"na"},"R2-2.1.1":{"s":"not_reviewed"},"R2-2.1.1/2":{"s":"not_reviewed"},"R2-2.2.1":{"s":"not_reviewed"},"R2-2.3.1":{"s":"na"},"R11-11.1.2":{"s":"approved"},"R11-11.1.1":{"s":"approved"},"R11-11.2.1":{"s":"na"},"R11-11.2.2":{"s":"approved"},"R11-11.3.1":{"s":"need_review"},"R11-11.3.1.1":{"s":"approved"},"R11-11.3.1.2.d":{"s":"approved"},"R11-11.3.2":{"s":"need_review"},"R11-11.4.2":{"s":"need_review"},"R11-11.4.3":{"s":"need_review"},"R11-11.4.6":{"s":"need_review"},"R11-11.5.1":{"s":"need_review"},"R11-11.5.1.1":{"s":"need_review"},"R11-11.5.2":{"s":"need_review"},"R12-12.1.1":{"s":"approved"},"R12-12.2.1":{"s":"approved"},"R12-12.3.1":{"s":"approved"},"R12-12.3.2":{"s":"approved"},"R12-12.3.3":{"s":"na"},"R12-12.3.4":{"s":"approved"},"R12-12.4.2":{"s":"approved"},"R12-12.5.2":{"s":"need_review"},"R12-12.6.1":{"s":"approved"},"R12-12.6.3":{"s":"approved"},"R12-12.7.1":{"s":"need_review"},"R12-12.8.1":{"s":"approved"},"R12-12.8.2":{"s":"need_review"},"R12-12.8.3.b":{"s":"need_review"},"R12-12.3.4/2":{"s":"approved"},"R12-12.8.5":{"s":"approved"},"R12-12.10.1":{"s":"approved"},"R12-12.10.2":{"s":"approved"},"R12-12.10.4.1":{"s":"na"},"R12-12.10.7":{"s":"na"}};
      ...
      const requirements = REQUIREMENTS.map(req => {
        ...
        return { id: req.id, name: req.name, total: eps.length, filled, empty: eps.length - filled,
          ...
          ieApproved, iePct: eps.length > 0 ? Math.round((ieApproved / eps.length) * 100) : 0 };
      });
